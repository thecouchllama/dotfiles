...
vim.cmd(
	"let g:go_metalinter_enabled = ['revive', 'errcheck', 'godox', 'prealloc', 'predeclared', 'wsl', 'deadcode', 'gosimple', 'govet', 'ineffassign', 'staticcheck', 'structcheck', 'typecheck', 'unused', 'varcheck']"
)
