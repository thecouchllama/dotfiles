...
map('n', '<space>D', '<cmd>Telescope lsp_type_definitions<CR>')
map('n', '<space>rn', '<cmd>lua vim.lsp.buf.rename()<CR>')
map('n', '<space>o', '<cmd>Telescope lsp_document_symbols<CR>')
map('n', '<space>c', '<cmd>Telescope lsp_code_actions<CR>')
map('n', 'gr', '<cmd>Telescope lsp_references<CR>')
map('n', '<space>e', '<cmd>Telescope lsp_document_diagnostics<CR>')
